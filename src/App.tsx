...
import OrganizeResearchNotesAI from "./pages/blog/OrganizeResearchNotesAI"; // New import
        ...
        <BrowserRouter>
          <UserProfileProvider>
            <Routes>
              ...
              <Route path="/blog/organize-research-notes-ai" element={<OrganizeResearchNotesAI />} /> {/* New route */}
